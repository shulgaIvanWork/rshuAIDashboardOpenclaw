...
// Поля для сделок PostSale
const POSTSALE_SELECT = [
  'ID', 'TITLE', 'STAGE_ID', 'STAGE_SEMANTIC_ID', 'CATEGORY_ID',
  'OPPORTUNITY', 'CURRENCY_ID', 'DATE_CREATE', 'DATE_MODIFY',
  'CLOSEDATE', 'CLOSED', 'ASSIGNED_BY_ID', 'SOURCE_ID',
  'COMPANY_ID', 'CONTACT_ID',
  'UF_CRM_1703146018908',   // NPS_SCORE (число, 1-10)
  'UF_CRM_1701751401798',   // NPS_CATEGORY (список)
  'UF_CRM_1701751424430',   // NPS_COMMENT (строка)
  'UF_FORMAT',               // Формат обучения (инфоблок 149: 19042467 Очный / 19042468 Онлайн / 19042469 Видеокурс)
  'UF_CRM_1476128242',       // POSTSALE_SRC_ID (ID исходной сделки Sale, заполняется БП №596)
  'UF_CRM_1702007619638',   // Отзыв из анкеты
  'UF_CRM_5DF2528C641D4',   // Статус участника обучения (Промоутер/Пассивный/Детрактор/Нет контактов)
  'UF_CRM_1697096074',       // Продукт
  'UF_CRM_1744961443398',   // Формат КОМ (не используется для среза — см. UF_FORMAT)
...
/**
 * Выгрузка сделок PostSale (CATEGORY_ID=9) для NPS-дашборда.
 * Отдельная функция — данные сохраняются в отдельный файл,
 * не смешиваются с основными сделками, не влияют на другие дашборды.
 */
