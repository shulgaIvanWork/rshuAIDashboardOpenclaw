  ...
  try {
    ...
    function section(title, ytd, cur, prev, cls, leadsYtd, leadsCur, leadsPrev, qualLeads, mqlCur, mqlPrev, ppYtd, ppLeads, ppQual) {
      ...
      var r = '<div class="kpis"><div class="kpi-header '+cc+'">'+title+'</div>'
        ...
        + '<div class="kpi '+kc+'">'
        + '<div class="row"><div class="lbl" style="margin:0">Оплаченные в&nbsp;периоде</div>'+(ppYtd?('<span style="white-space:nowrap">'+pctDelta(ytd.paid_created_same_pct,ppYtd.paid_created_same_pct)+'</span>'):'')+'</div>'
        + '<div style="margin:2px 0"><span class="val-big">'+fmtPct(ytd.paid_created_same_pct)+'%</span><span class="si"> · '+fmt(ytd.paid_same_period||0)+' · '+fmtCompact(ytd.paid_same_period_sum||0)+' &#8381;</span></div>'
        + (ppYtd?('<div class="pp-val" style="font-size:13px">'+fmtPct(ppYtd.paid_created_same_pct)+'% · '+fmt(ppYtd.paid_same_period||0)+' · '+fmtCompact(ppYtd.paid_same_period_sum||0)+' &#8381;</div>'):'')
        + '</div>'
