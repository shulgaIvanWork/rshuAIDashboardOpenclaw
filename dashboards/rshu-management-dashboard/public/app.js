  ...
  try {
    ...
    function section(title, ytd, cur, prev, cls, leadsYtd, leadsCur, leadsPrev, qualLeads, mqlCur, mqlPrev) {
      ...
      var r = '<div class="kpis"><div class="kpi-header '+cc+'">'+title+wkLabel+'</div>'
        + '<div class="kpi '+kc+'"><div class="lbl">Поступления</div><div class="row"><div class="val">'+fmt(ytd.postupleniya)+' \u20bd</div><span class="si">('+fmt(ytd.won_relevant_cnt)+' сд.)</span></div></div>'
        + '<div class="kpi '+kc+'"><div class="lbl">\ud83d\udccb Лиды всего</div><div class="row"><div class="val-big">'+fmt(leadsYtd != null ? leadsYtd : ytd.won_relevant_cnt)+'</div><span class="si">конв. '+((qualLeads/leadsYtd*100).toFixed(1))+'%</span></div><div class="lbl2">квал. лиды (MQL)</div><div class="val-big '+cc+'">'+fmt(qualLeads)+'</div></div>'
        + '<div class="kpi '+kc+'"><div class="lbl">\ud83d\udcc8 Конверсия всего</div><div class="row"><div class="val-big">'+fmtPct(leadsYtd>0?(ytd.won_relevant_cnt/leadsYtd*100):0)+'%</div><span class="si">всех лидов</span></div><div class="lbl2">Конверсия квал. лидов (MQL)</div><div class="row"><div class="val-big '+cc+'">'+fmtPct(qualLeads>0?(ytd.won_relevant_cnt/qualLeads*100):0)+'%</div><span class="si">квал. лидов (MQL)</span></div></div>'
        ...
        + '<div class="kpi '+kc+'"><div class="lbl">\u0426\u0438\u043a\u043b сделки</div><div class="row"><div class="val">'+(ytd.avg_close_days_won||0).toFixed(1)+' дн.</div></div></div>'
