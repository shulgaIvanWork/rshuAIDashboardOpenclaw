  ...
  try {
    ...
    function section(title, ytd, cur, prev, cls, leadsYtd, leadsCur, leadsPrev, qualLeads, mqlCur, mqlPrev) {
      ...
      var r = '<div class="kpis"><div class="kpi-header '+cc+'">'+title+wkLabel+'</div>'
        ...
        + '<div class="kpi '+kc+'"><div class="lbl">\u0426\u0438\u043a\u043b сделки</div><div class="val">'+(ytd.avg_close_days_won||0).toFixed(1)+' дн.</div></div>'
        + '<div class="kpi '+kc+'"><div class="lbl">\u041d\u0435\u0434\u0435\u043b\u044f: поступления</div><div class="row"><div class="val">'+fmt(cur.postupleniya)+' \u20bd</div><span class="si">'+delta(cur.postupleniya, prev.postupleniya)+'</span></div></div>'
