  ...
  try {
    ...
    function section(title, ytd, cur, prev, cls, leadsYtd, leadsCur, leadsPrev, qualLeads, mqlCur, mqlPrev) {
      ...
      var r = '<div class="kpis"><div class="kpi-header '+cc+'">'+title+'</div>'
        ...
        + '<div class="kpi '+kc+'"><div class="lbl">Неделя'+ (weekDates ? '('+weekDates+'):' : ':') +' поступления</div><div class="row"><div class="val-big">'+fmt(cur.postupleniya)+' \u20bd</div><span class="si">'+delta(cur.postupleniya, prev.postupleniya)+'</span></div><div class="lbl2">Оплачено сделок</div><div class="row"><div class="val-big '+cc+'">'+fmt(cur.won_relevant_cnt)+'</div></div></div>'
