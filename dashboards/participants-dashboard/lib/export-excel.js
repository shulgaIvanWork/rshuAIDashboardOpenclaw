...
const COLUMNS = [
  ...
  { header: 'Длит. дней', key: 'moduleDuration', width: 10 },
  { header: 'Цикл дней', key: 'dealCycle', width: 10 },
  { header: 'Статус', key: 'stage', width: 16 },
  { header: 'Пред. обуч.', key: 'prevTrainingDate', width: 14 },
  { header: 'Посл. обуч. в комп.', key: 'lastCompanyTraining', width: 16 },
